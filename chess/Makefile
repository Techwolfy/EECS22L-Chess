...
.PHONY: release
release: | all
	tar cvzf Chess_V1.0.tar.gz --exclude=CVS README COPYRIGHT INSTALL bin/ doc/
	tar cvzf Chess_V1.0_src.tar.gz --exclude=CVS README COPYRIGHT INSTALL Makefile bin/ doc/ inc/ src/ test/
